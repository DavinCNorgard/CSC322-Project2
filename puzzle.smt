...
(assert (= 7 (+ V11 V18))) 
(assert (= 8 (+ V12 V13))) 
(assert (= 17 (+ V14 V21 V22))) 
(assert (= 8 (+ V15 V16))) 
(assert (= 13 (+ V17 V24 V25 V26))) 
(assert (= 10 (+ V19 V20 V27))) 
(assert (= 18 (+ V23 V30 V37))) 
(assert (= 15 (+ V28 V29 V35 V42))) 
(assert (= 11 (+ V31 V32 V39))) 
(assert (= 9 (+ V33 V34))) 
(assert (= 6 (+ V36 V43 V44))) 
(assert (= 10 (+ V40 V47))) 
(assert (= 9 (+ V41 V48))) 
(assert (= 9 (+ V45 V46))) 
(check-sat)
